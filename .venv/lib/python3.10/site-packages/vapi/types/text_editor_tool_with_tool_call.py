...
class TextEditorToolWithToolCall(UncheckedBaseModel):
    ...
    messages: typing.Optional[typing.List[TextEditorToolWithToolCallMessagesItem]] = pydantic.Field(default=None)
    """
