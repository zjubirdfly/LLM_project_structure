...
class GoogleCalendarCheckAvailabilityTool(UncheckedBaseModel):
    ...
    messages: typing.Optional[typing.List[GoogleCalendarCheckAvailabilityToolMessagesItem]] = pydantic.Field(
        default=None
    )
    """
