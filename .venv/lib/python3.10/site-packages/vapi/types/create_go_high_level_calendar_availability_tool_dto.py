...
class CreateGoHighLevelCalendarAvailabilityToolDto(UncheckedBaseModel):
    ...
    messages: typing.Optional[typing.List[CreateGoHighLevelCalendarAvailabilityToolDtoMessagesItem]] = pydantic.Field(
        default=None
    )
    """
