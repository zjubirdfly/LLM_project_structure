...
class GoHighLevelContactGetToolWithToolCall(UncheckedBaseModel):
    ...
    messages: typing.Optional[typing.List[GoHighLevelContactGetToolWithToolCallMessagesItem]] = pydantic.Field(
        default=None
    )
    """
