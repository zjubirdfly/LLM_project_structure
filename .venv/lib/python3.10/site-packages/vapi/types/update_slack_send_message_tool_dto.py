...
class UpdateSlackSendMessageToolDto(UncheckedBaseModel):
    ...
    messages: typing.Optional[typing.List[UpdateSlackSendMessageToolDtoMessagesItem]] = pydantic.Field(default=None)
    """
