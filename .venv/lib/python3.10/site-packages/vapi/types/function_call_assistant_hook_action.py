...
from .function_call_assistant_hook_action_messages_item import FunctionCallAssistantHookActionMessagesItem
from .open_ai_function import OpenAiFunction
from .server import Server


class FunctionCallAssistantHookAction(UncheckedBaseModel):
    ...
    messages: typing.Optional[typing.List[FunctionCallAssistantHookActionMessagesItem]] = pydantic.Field(default=None)
    """
