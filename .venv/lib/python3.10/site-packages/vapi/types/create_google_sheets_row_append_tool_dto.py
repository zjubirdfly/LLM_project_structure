...
class CreateGoogleSheetsRowAppendToolDto(UncheckedBaseModel):
    ...
    messages: typing.Optional[typing.List[CreateGoogleSheetsRowAppendToolDtoMessagesItem]] = pydantic.Field(
        default=None
    )
    """
