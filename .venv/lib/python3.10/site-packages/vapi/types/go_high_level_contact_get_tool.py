...
class GoHighLevelContactGetTool(UncheckedBaseModel):
    ...
    messages: typing.Optional[typing.List[GoHighLevelContactGetToolMessagesItem]] = pydantic.Field(default=None)
    """
