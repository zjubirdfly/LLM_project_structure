...
class ComputerToolWithToolCall(UncheckedBaseModel):
    ...
    messages: typing.Optional[typing.List[ComputerToolWithToolCallMessagesItem]] = pydantic.Field(default=None)
    """
