...
class UpdateComputerToolDto(UncheckedBaseModel):
    ...
    messages: typing.Optional[typing.List[UpdateComputerToolDtoMessagesItem]] = pydantic.Field(default=None)
    """
    ...
    display_width_px: typing_extensions.Annotated[typing.Optional[float], FieldMetadata(alias="displayWidthPx")] = (
        pydantic.Field(default=None)
    )
    """
    ...
    display_height_px: typing_extensions.Annotated[typing.Optional[float], FieldMetadata(alias="displayHeightPx")] = (
        pydantic.Field(default=None)
    )
    """
