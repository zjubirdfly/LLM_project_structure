...
class UpdateGoogleCalendarCheckAvailabilityToolDto(UncheckedBaseModel):
    ...
    messages: typing.Optional[typing.List[UpdateGoogleCalendarCheckAvailabilityToolDtoMessagesItem]] = pydantic.Field(
        default=None
    )
    """
