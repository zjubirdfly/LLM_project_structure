...
class GoHighLevelContactCreateToolWithToolCall(UncheckedBaseModel):
    ...
    messages: typing.Optional[typing.List[GoHighLevelContactCreateToolWithToolCallMessagesItem]] = pydantic.Field(
        default=None
    )
    """
