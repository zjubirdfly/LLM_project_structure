...
class UpdateGoHighLevelCalendarAvailabilityToolDto(UncheckedBaseModel):
    ...
    messages: typing.Optional[typing.List[UpdateGoHighLevelCalendarAvailabilityToolDtoMessagesItem]] = pydantic.Field(
        default=None
    )
    """
