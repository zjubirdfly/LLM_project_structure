...
class CreateGoogleCalendarCheckAvailabilityToolDto(UncheckedBaseModel):
    ...
    messages: typing.Optional[typing.List[CreateGoogleCalendarCheckAvailabilityToolDtoMessagesItem]] = pydantic.Field(
        default=None
    )
    """
