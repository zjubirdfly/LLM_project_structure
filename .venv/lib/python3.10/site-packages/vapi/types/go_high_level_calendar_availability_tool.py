...
class GoHighLevelCalendarAvailabilityTool(UncheckedBaseModel):
    ...
    messages: typing.Optional[typing.List[GoHighLevelCalendarAvailabilityToolMessagesItem]] = pydantic.Field(
        default=None
    )
    """
