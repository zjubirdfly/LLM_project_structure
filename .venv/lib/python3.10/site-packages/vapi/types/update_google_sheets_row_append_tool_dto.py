...
class UpdateGoogleSheetsRowAppendToolDto(UncheckedBaseModel):
    ...
    messages: typing.Optional[typing.List[UpdateGoogleSheetsRowAppendToolDtoMessagesItem]] = pydantic.Field(
        default=None
    )
    """
