...
class CreateTransferCallToolDto(UncheckedBaseModel):
    ...
    messages: typing.Optional[typing.List[CreateTransferCallToolDtoMessagesItem]] = pydantic.Field(default=None)
    """
