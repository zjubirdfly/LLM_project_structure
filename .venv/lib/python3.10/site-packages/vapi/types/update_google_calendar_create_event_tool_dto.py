...
class UpdateGoogleCalendarCreateEventToolDto(UncheckedBaseModel):
    ...
    messages: typing.Optional[typing.List[UpdateGoogleCalendarCreateEventToolDtoMessagesItem]] = pydantic.Field(
        default=None
    )
    """
