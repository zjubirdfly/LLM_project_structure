...
class GoHighLevelCalendarAvailabilityToolWithToolCall(UncheckedBaseModel):
    ...
    messages: typing.Optional[typing.List[GoHighLevelCalendarAvailabilityToolWithToolCallMessagesItem]] = (
