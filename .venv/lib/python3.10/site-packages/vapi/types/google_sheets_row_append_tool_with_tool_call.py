...
class GoogleSheetsRowAppendToolWithToolCall(UncheckedBaseModel):
    ...
    messages: typing.Optional[typing.List[GoogleSheetsRowAppendToolWithToolCallMessagesItem]] = pydantic.Field(
        default=None
    )
    """
